...
#define CODESPACE 4000		/* maximum number of machine instructions */
...
#define CYCLE_LIMIT 2000000L	/* limit of background cycles */
...
/* number of robots active in the battle */
#ifndef INIT
extern
#endif
int num_robots;
...
typedef struct {
    int x, y;
    int heading;
    int status;         /* AVAIL=0, FLYING=1, EXPLODING=2 */
    int owner;
} MissileFrame;
